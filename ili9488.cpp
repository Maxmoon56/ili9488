...
#endif
    //
  madctl |=MADCTL_BGR_PIXEL_ORDER; //_ROTATE_180_DEGREES;
    ...
    //  SPI_TRANSFER(SPI_CS_BIT,0x36,  0xE0);
...
// the original test value was set to.
      ...
      SPI_TRANSFER(SPI_CS_BIT, 0xB4, 0x03); //0x02
     ...
     /// SPI_TRANSFER(SPI_CS_BIT, 0x21);
      ...
      SPI_TRANSFER(SPI_CS_BIT, 0xB6, 0x02, 0x02);  //02
      // 0xE9 Set Image Function.
      SPI_TRANSFER(SPI_CS_BIT, 0xE9, 0x00); //01
